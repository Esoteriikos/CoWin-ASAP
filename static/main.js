...
function load()
{
    ...
    if (date==null || date==''){
        ...
        date = dd + '-' + mm + '-' + yyyy;
        // document.getElementById("demo").innerHTML = curr_time[3]; 
    }
    filter_txt += "\nDate: "+date
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if ("centers" in data_json)
            {
                ...
                var txt_col = "<tr><th>Center ID</th><th>Center Name</th><th>District</th><th>Pincode</th><th>Vaccine</th><th>Minimum Age</th><th>DOSE 1</th><th>DOSE 2</th><th>Total Doses</th><th>FEE</th></tr>"
            ...
            else if ("error" in data_json) document.getElementById("fetch-failed").innerHTML = "API Failed to Fetch Data : "+data_json.error;
        }
